...
export class AppService {
  ...
  async loadSpecial() {
    const special = await this.prisma.eventSpeciality.createMany({
      data: [
        ...
        { title: '25.02.03 - Техническая эксплуатация электрифицированных и пилотажно-навигационных комплексов' },
        { title: '25.02.06 - Производсвто и обслуживание авиационной техники' },
        { title: '25.02.08 - Эксплуатация беспилотных авиационных систем' },
        { title: '23.02.05 - Эксплуатация транспортного электрооборудования и автоматики (по видам транспорта, за исключением водного)'},
        { title: '05.02.16 - Эксплуатация и ремонт сельскохозяйственной техники и оборудования' },
